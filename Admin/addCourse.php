...
include('../dbConnection.php');
 ...
 if(isset($_REQUEST['courseSubmitBtn'])){
  ...
  if(($_REQUEST['course_name'] == "") || ($_REQUEST['course_desc'] == "") || ($_REQUEST['course_author'] == "") || ($_REQUEST['course_duration'] == "") || ($_REQUEST['course_price'] == "") || ($_REQUEST['course_original_price'] == "")){
   ...
   $img_folder = '../image/courseimg/'. $course_image;  // creating course img folder
   move_uploaded_file($course_image_temp, $img_folder); //moving the image into folder
...
<div class="col-sm-6 mt-5  mx-3 jumbotron">
  ...
  <form action="" method="POST" enctype="multipart/form-data">  <!--enctype cuz we have to deal with course's images-->
